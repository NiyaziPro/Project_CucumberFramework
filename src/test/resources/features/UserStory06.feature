...
Feature: User Story 06 - User must be able to buy a product.
  ...
  Background:
    Given user goes to the "allovercommerceUrl" site and logs in with valid information.
