...
public class ReusableMethods {
    ...
    public static void screenShot(String name) {
        ...
        String filePath = System.getProperty("user.dir") + "/src/test/java/allovercommerceTestNG/testOutputs/screenshots/" + name + "_" + date + ".png";
        try {
    ...
    public static void screenShotOfWebElement(WebElement webElement) {
        String date = DateTimeFormatter.ofPattern("dd.MM.yyyy_HH.mm.ss").format(LocalDateTime.now());
        String filePath = System.getProperty("user.dir") + "/src/test/java/allovercommerceTestNG/testOutputs/webElementScreenshots/" + date + ".png";
        try {
